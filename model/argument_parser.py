...
def create_arg_parser():
    ...
    parser.add_argument('--validation_path', type=str, default='Data\images_Y10_val_150.npy', help='Path to the validation data.')
    parser.add_argument('--validation_labels_path', type=str, default='Data\labels_valid.npy', help='Path to the validation labels.')
